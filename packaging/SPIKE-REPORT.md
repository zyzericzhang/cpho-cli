...
Latest decision baseline: GitHub Actions run `26590319698` on `windows-2022` produced a PyInstaller bundle, passed packaged smoke, and uploaded artifacts. Nuitka timed out without producing an executable.
