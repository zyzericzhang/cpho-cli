...
- [explain](explain.md) — 多 Tone 讲解、句子级解释和候选标签回写。
...
- [community-kb](community-kb.md) — 从 pinned GitHub release 同步只读社区知识库。
- [model-panel](model-panel.md) — 查看 skill pipeline 并设置每步模型。
